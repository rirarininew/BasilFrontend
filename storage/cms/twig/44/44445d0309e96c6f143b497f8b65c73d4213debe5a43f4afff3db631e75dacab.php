...
/* C:\xampp\htdocs\install-master/themes/thebakerdev-zenii/partials/footer.htm */
class __TwigTemplate_92615a174a417aade3e966aed04533a59073e25b9ef3838aeafb7e9985649e3c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container section mx-auto py-10\">
        ...
        <div class=\"footer__content\">
            ...
            <ul class=\"text-sm\">
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/#about\">Tentang Kami</a></li>
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/#services\">Solusi Usaha</a></li>
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/#contact\">Kontak</a></li>
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/#pricing\">Harga</a></li>
            </ul>
        </div>
        <div class=\"footer__content\">
             <h4 class=\"text-lg font-bold mb-4\">Solusi Usaha</h4>
            <ul class=\"text-sm\">
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/restaurant/#restaurant\">Restaurant</a></li>
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/restaurant/#retail\">Retail</a></li>
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/restaurant/#cafe\">Cafe</a></li>
                <li class=\"mb-2\"><a class=\"hover:text-primary\" href=\"http://localhost/install-master/restaurant/#bakery\">Bakery</a></li>
            </ul>
        </div>
        <div class=\"footer__content\">
            <h4 class=\"text-lg font-bold mb-4\">";
    ...
    {
        return "C:\\xampp\\htdocs\\install-master/themes/thebakerdev-zenii/partials/footer.htm";
    }
...
</footer>", "C:\\xampp\\htdocs\\install-master/themes/thebakerdev-zenii/partials/footer.htm", "");
    }
}
