...
/* C:\xampp\htdocs\install-master/themes/thebakerdev-zenii/layouts/solusiusaha-bakery.htm */
class __TwigTemplate_b2185afa79dc15ab96750d61c1bc4c086cd82cd258ead1fa9dff8f0e776a1682 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <body class=\"font-body\">
        ...
        // line 10
        $context['__cms_partial_params'] = [];
        echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("bakery"        , $context['__cms_partial_params']        , true        );
        unset($context['__cms_partial_params']);
        // line 11
        echo "            
            ";
        // line 12
        $context['__cms_partial_params'] = [];
        echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("about-bakery"        , $context['__cms_partial_params']        , true        );
        unset($context['__cms_partial_params']);
        // line 13
        echo "            
            ";
    ...
    {
        return "C:\\xampp\\htdocs\\install-master/themes/thebakerdev-zenii/layouts/solusiusaha-bakery.htm";
    }
...
</html>", "C:\\xampp\\htdocs\\install-master/themes/thebakerdev-zenii/layouts/solusiusaha-bakery.htm", "");
    }
}
